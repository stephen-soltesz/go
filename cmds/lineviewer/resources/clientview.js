...
go$packages["github.com/gopherjs/jquery"] = (function() {
	var go$pkg = {}, js = go$packages["github.com/gopherjs/gopherjs/js"], JQuery, Event, JQueryCoordinates, NewJQuery, GetJSON;
...
go$packages["math"] = (function() {
	var go$pkg = {}, js = go$packages["github.com/gopherjs/gopherjs/js"], Floor, Ldexp, Float32bits, Float32frombits, math, zero, negInf, nan, pow10tab;
	Floor = go$pkg.Floor = function(x) {
		return go$parseFloat(math.floor(x));
	};
...
go$packages["strconv"] = (function() {
	var go$pkg = {}, math = go$packages["math"], errors = go$packages["errors"], utf8 = go$packages["unicode/utf8"];
	go$pkg.init = function() {
...
go$packages["strings"] = (function() {
	var go$pkg = {}, js = go$packages["github.com/gopherjs/gopherjs/js"], errors = go$packages["errors"], io = go$packages["io"], utf8 = go$packages["unicode/utf8"], unicode = go$packages["unicode"];
	go$pkg.init = function() {
	}
	return go$pkg;
})();
go$packages["main"] = (function() {
	...
	addCanvas = function(containerName, canvasName, width, height) {
		...
		mouseDown = false;
		mousePrevPos = null;
		document.onmousedown = go$externalize((function(evt) {
			mouseDown = true;
			mousePrevPos = null;
			updateInterval = 200;
		}), (go$funcType([js.Object], [], false)));
		document.onmouseup = go$externalize((function(evt) {
			mouseDown = false;
			updateInterval = 1000;
		}), (go$funcType([js.Object], [], false)));
		document.onmousemove = go$externalize((function(evt) {
			var curr, prev;
			if (mouseDown) {
	...
	jsOnConfig = function(containerName, data) {
		var width, height;
		if (firstRun) {
	...
	setupSocket = function(socketUrl, containerName) {
		jquery.GetJSON(new (go$sliceType(go$emptyInterface))([new Go$String("/config"), new (go$funcType([js.Object], [], false))((function(data) {
	...
	go$pkg.init = function() {
		...
		(go$ptrType(Image)).methods = [["Bool", "", [], [Go$Bool], false, 0], ["Call", "", [Go$String, (go$sliceType(go$emptyInterface))], [js.Object], true, 0], ["Delete", "", [Go$String], [], false, 0], ["Float", "", [], [Go$Float64], false, 0], ["Get", "", [Go$String], [js.Object], false, 0], ["Index", "", [Go$Int], [js.Object], false, 0], ["Int", "", [], [Go$Int], false, 0], ["Int64", "", [], [Go$Int64], false, 0], ["Interface", "", [], [go$emptyInterface], false, 0], ["Invoke", "", [(go$sliceType(go$emptyInterface))], [js.Object], true, 0], ["IsNull", "", [], [Go$Bool], false, 0], ["IsUndefined", "", [], [Go$Bool], false, 0], ["Length", "", [], [Go$Int], false, 0], ["New", "", [(go$sliceType(go$emptyInterface))], [js.Object], true, 0], ["Set", "", [Go$String, go$emptyInterface], [], false, 0], ["SetIndex", "", [Go$Int, go$emptyInterface], [], false, 0], ["Str", "", [], [Go$String], false, 0], ["Uint64", "", [], [Go$Uint64], false, 0], ["Unsafe", "", [], [Go$Uintptr], false, 0], ["addEventListener", "main", [Go$String, Go$Bool, (go$funcType([], [], false))], [], false, -1]];
